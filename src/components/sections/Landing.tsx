...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="size-[600px] absolute border bottom-0 translate-y-1/2 border-border  rounded-full " />
        <div className="size-[800px] absolute border bottom-0 translate-y-1/2 border-border/90 rounded-full " />
        <div className="size-[600px] absolute border bottom-0 translate-y-1/2 border-border/80 rounded-full " />
        <div className="size-[600px] absolute border bottom-0 translate-y-1/2 border-border/70 rounded-full " />
        <div className="size-[550px] absolute border bottom-0 translate-y-1/2 border-border/65 rounded-full " />
        <div className="size-[500px] absolute border bottom-0 translate-y-1/2 border-border/60 rounded-full " />
        <div className="size-[400px] absolute border bottom-0 translate-y-1/2 border-border/40 rounded-full " />
      </motion.div>
      <motion.div
        style={{ left: tX }}
        animate={{ opacity: 1 }}
