...
export function EmailTemplate({ name }: EmailTemplate) {
  return `
<!doctype html>
<html>
    <head>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="message">
                    ...
                    <br /><br />
                    We're thrilled to have you join our community of early
                    adopters. You're now part of an exclusive group that will
                    get <span class="highlight">first access</span> to Rae when
                    we launch. <br /><br />
                    <strong>What's next?</strong>
                    <ul style="margin: 15px 0; padding-left: 20px">
                        <li>
                            You'll be among the first to know when Rae is ready
                        </li>
                    ...
                    We're working hard to bring you something amazing. Rae will
                    revolutionize how you interact with your desktop, making
                ...
                <div style="text-align: center; margin: 20px 0">
                    ...
                    >
                        <strong
                            >🔥 You're in the queue for our early
                            access!</strong
                        >
                    </div>
                </div>
